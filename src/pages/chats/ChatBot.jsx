...
export function ChatBot() {
  ...
  return (
    <>
      ...
      >
        <div id="leftnav" class="left-bar hide">
          <div class="search">
            <input type="text" name="" id="idSearch" placeholder="Buscar" />
          </div>
          <div class="chats">
            <div class="chats_msgs">
              <img
                class="chats_profile_pic"
                src="./img/SVG/chatbot.svg"
                alt=""
              />
              <div class="chats_text">
                ...
                <small>
                  ...
                  Numquam aliquid qui rem odit, provident optio omnis similique.
                  Exercitationem dolorum, nam modi provident ea cupiditate
                  repudiandae tempora, cum facere sed aperiam.
                </small>
              </div>
            </div>
            <div class="chats_msgs">
